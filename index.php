...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="assets/images/logosh.jpg">
    <title>Shukhrat - Home</title>
        ...
        <div class="preloader">
            <div class="vertical-centered-box">
                <div class="content">
                    ...
                    <img src="assets/images/logosh.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- end preloader -->
                            ...
                            <div class="col-lg-2 col-md-6 col-6">
                                <div class="navbar-header">
                                    <a class="navbar-brand site-logo" href="index.php"><img
                                                src="assets/images/logosh.jpg" alt="">Shukhrat.</a>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-12">
                                <div class="wpo-static-hero-inner">
                                    ...
                                    <div data-swiper-parallax="400" class="slide-text">
                                        <p>"Hello! I'm Shukhrat, your web developer ready for innovations
                                            and challenging solutions. My advantage lies in the unique blend
                                            of creative thinking and technical craftsmanship.
                                            I create functional and stylish websites that help clients
            ...
            <div class="static-hero-right">
                <div class="static-hero-img">
                    <div class="static-hero-img-inner">
                        <img src="assets/images/slider/logosh1.jpg" alt="">
                        <div class="icon-1 floating-item"><img src="assets/images/icon/php.svg" alt=""></div>
                        <div class="icon-2 floating-item"><img src="assets/images/icon/js.svg" alt=""></div>
                        <div class="icon-3 floating-item"><img src="assets/images/icon/sql.svg" alt=""></div>
                        ...
                        <div class="wpo-about-content">
                            <div class="wpo-about-title">
                                ...
                                <p>Experienced Web Developer adept in all stages of advanced web development.
                                    ...
                                    JavaScript, JQuery, PHP, Linux and SQL Server.
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-12">
                        <div class="wpo-section-title">
                            ...
                            <p>My professional journey has been an exciting adventure, during which I've gained
                                experience and confidence in the fact that web development is my passion and calling.
                                My projects have become real achievements for me, and each one is a fresh challenge
                                that allows me to unlock my potential.

                                Programming, to me, is more than just lines of code; it's a means of transforming
                                concepts and ideas into virtual reality. My works are my sources of pride,
                                reflecting my commitment to quality and creative thinking.
                                Every project I complete is a new challenge that enables me to grow and improve.</p>
                        </div>
                    </div>
                </div>
                <div class="wpo-work-wrap">
                    <div class="wpo-work-item">
                        <ul>
                            <li class="date">2008 - 2014</li>
                            <li class="logo"><img src="assets/images/work/uztvor1.jpeg" alt=""></li>
                            <li class="position">Uzvtorcvetmet.uz <span>IT Specialist, UZB.</span></li>
                            <!--<li class="link"><a href="#">Go to website</a></li>-->
                        </ul>
                    </div>
                    <div class="wpo-work-item">
                        <ul>
                            <li class="date">2014 - 2018</li>
                            <li class="logo"><img src="assets/images/work/unicon.uz.png" alt=""></li>
                            <li class="position">Unicon.uz <span>Web developer, UZB<span></span></span></li>
                            <!--<li class="link"><a href="#">Go to website</a></li>-->
                        </ul>
                    </div>
                    <div class="wpo-work-item">
                        <ul>
                            <li class="date">2015 - 2019</li>
                            <li class="logo"><img src="assets/images/work/galaxy1.png" alt=""></li>
                            <li class="position">Galaxy Electronics <span>Private Business. Trade in computers and smartphones, UZB</span></li>
                            <!--<li class="link"><a href="#">Go to website</a></li>-->
                        </ul>
                    </div>
                    <div class="wpo-work-item">
                        <ul>
                            <li class="date">2021 - <span>Present day</span></li>
                            <li class="logo"><img src="assets/images/work/myitedu.jpeg" alt=""></li>
                            <li class="position">MYITEDU  <span>Web developer, Brooklyn NY,
                ...
                <div class="wpo-section-title-s2">
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-12">
                            <div class="title">
                                <h2>Recent Work.</h2>
                                <p>Here you can view my recent work which reflects my skills and style.</p>
                            </div>
                        </div>
                ...
                <div class="wpo-project-wrap wpo-project-slide owl-carousel">
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets/images/project/audi1.png" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#portfolio-single.html">Audi-1</a></h2>
                            <span>Website Architecture</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets/images/project/audi2.png" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#portfolio-single.html">Audi-2</a></h2>
                            <span>Website Design</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets/images/project/audi3.png" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#portfolio-single.html">Audi-3</a></h2>
                            <span>Website Creative</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets/images/project/login.png" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#portfolio-single.html">Login Form</a></h2>
                            <span>Web Design / Backend</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets/images/project/uzb_dmv.png" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#portfolio-single.html">DMV Uzbekistan</a></h2>
                            <span>Website Database</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets/images/project/restaurant.png" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#portfolio-single.html">Restaurant Calculator</a></h2>
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="widget about-widget">
                                <div class="logo widget-title">
                                    <a class="site-logo" href="index.html"><img src="assets/images/logosh.jpg"
                                            alt="">Shukhrat.</a>
                                </div>
                                <p>Welcome!</p>
            ...
            <div class="lower-footer">
                <div class="container">
                    <div class="row">
                        ...
                        <p class="copyright">shukhratnyc.com &copy; 2023 Shukhrat. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
