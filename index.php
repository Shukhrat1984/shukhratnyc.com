...
<div class="container-fluid">
    ...
    <div class="container1">
        <!--Bubble-container1-->
        <div data-bubble-hue="220" data-bubble-count="30" class="bubble-container">
    ...
    <div class="container3">
        <div class="box">
            <a href="#">
                <img src="img1/shukhrat1.jpg" alt="Image 1">
        ...
        <div class="box">
            <a href="#">
                <img src="img1/shukhrat2.jpg" alt="Image 2">
                <span class="text-overlay">
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-laptop"
                     viewBox="0 0 16 16">
        ...
        <div class="box">
            <a href="#">
                <img src="img1/shukhrat3.jpg" alt="Image 3">
                <span class="text-overlay">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-bag"
                     viewBox="0 0 16 16">
        ...
        <div class="box">
            <a href="#">
                <img src="img1/shukhrat4.jpg" alt="Image 4">
                <span class="text-overlay">
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor"
                     class="bi bi-suitcase" viewBox="0 0 16 16">
    ...
    <!-- Container style for Bubble-container2, Globe World, Preloader-Ring section starting-->
    <div class="container4">
        <!--Bubble-container2-->
        <div id="bubble2" data-bubble-hue="290" data-bubble-count="40" class="bubble-container">
            <!-- data-bubble-hue - Цвет в градусах HSL (таблица цветов).-->
            <!-- data-bubble-count - Количество пузырей.-->
            <div class="bubble-content">
                <h2>My Advantage</h2>
    ...
    <!-- Container style for Bubble-container2, Globe World, Preloader-Ring section ending-->
    <!-- Frame for social media section starting-->
    <div class="corner-box-8">
        <div class="corner-textbox-8">
            ...
            <ul class="social-icons-7">
                ...
                <li><a href="tel:+79999999999"><i class="fab fa-whatsapp"></i></a></li>
                <li><a href="tel:+79999999999"><i class="fab fa-telegram-plane"></i></a></li>
            </ul>
            <!-- Social media section ending-->
        </div>
    </div>
    <!-- Frame for social media section ending-->
