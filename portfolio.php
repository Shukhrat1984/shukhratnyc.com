...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="assets/images/loading.jpg">
    <title>Shukhrat - Portfolio</title>
                            ...
                            <div class="col-lg-2 col-md-6 col-6">
                                <div class="navbar-header">
                                    <a class="navbar-brand site-logo" href="index.php"><img
                                            src="assets/images/loading.jpg" alt="">Shukhrat.</a>
                                </div>
                            </div>
                                    ...
                                    <ul class="nav navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a class="active" href="portfolio.html">Portfolio Slide</a></li>
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="widget about-widget">
                                <div class="logo widget-title">
                                    <a class="site-logo" href="index.php"><img src="assets/images/logosh.jpg"
                                                                               alt="">Shukhrat.</a>
                                </div>
                                <p>Welcome!</p>
