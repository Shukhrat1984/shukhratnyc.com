...
<main class="sgroup-container">
    <section class="sgroup">
        ...
        <div class="title-box">Front-end v back-end development: What you need to know</div>
        <div class="info-box">
            <div class="info-col-1">
                <img src="blog_img/img-blog1.jpg" alt=""/>
            </div>
    ...
    <section class="sgroup">
        <div class="close-sgroup">&times;</div>
        <div class="title-box">Have U got X and I mixed up? The difference between UX and UI</div>
        <div class="info-box">
            <div class="info-col-1">
                <img src="blog_img/img-blog2.jpg" alt="" />
            </div>
            <div class="info-col-2">
                <p> <h6>Developers and designers</h6>
                    ...
                    <br>
                    <br>
                    <h6>Tech developments equal more UI and UX jobs</h6>
                    ...
                    When Jobs launched the iPad in 2010, apps really took off and people were using three online platforms, so there was a need for responsive design to make the desktop, phone and tablet all look and feel the same.                <br>
                    <br>
                    <br>
                    <h6>Evolving jobs in tech</h6>
                    ...
                    Dependent on your skills and how you want to develop your career, you can slot into anywhere along this job skill spectrum, from HTML5, Java, CSS3, jQuery, Objective-C, C# and JavaScript through Photoshop, Sketch, Illustrator, Fireworks, InVision, After Effects, Core Composer, Flash and Origami.
                    <br>
                    <br>
                    <h6>Salaries for UX and UI jobs</h6>
    ...
    <section class="sgroup">
        <div class="close-sgroup">&times;</div>
        <div class="title-box">Amethyst Care: AI assistant to help older people live at home for longer</div>
        <div class="info-box">
            <div class="info-col-1">
                <img src="blog_img/img-blog3.jpg" alt="" />
            </div>
            <div class="info-col-2">
                <p> <h6>Rebecca McManus is no stranger to the many challenges and complexities of being a caregiver, having assumed the role for both her parents at various stages of life.</h6>
    ...
    <section class="sgroup">
        <div class="close-sgroup">&times;</div>
        <div class="title-box">8 great alternatives to ChatGPT for workers</div>
        <div class="info-box">
            <div class="info-col-1">
                <img src="blog_img/img-blog4.jpg" alt="" />
            </div>
            <div class="info-col-2">
